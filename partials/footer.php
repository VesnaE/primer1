  ...
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-md-4">
        ...
        <p class="py-3">EKOportal kao izvor informacija iz Srbije i regiona. Pokrivamo teme ekologije, zaštite životne sredine,
          cirkularne ekonomije, održivog razvoja, i drugih eko tema.</p>
      ...
      <div class="col-md-3 text-center">
        <h4>Preuzmite Ekoheroj aplikaciju</h4>
